...
async function connectToNetwork(userId) {
    try {
        ...
        if (!identity) {
            console.log(`Usuario ${userId} no existe en el wallet, regístrelo primero.`);
...
async function registerUser(username, role) {
    ...
    try {
        ...
        return { success: true, message: 'Usuario registrado y matriculado correctamente' };
...
async function enrollAdmin() {
    try {
        ...
        console.log('Available CAs:', Object.keys(connectionProfile.certificateAuthorities));
